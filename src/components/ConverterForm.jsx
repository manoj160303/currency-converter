...
const ConverterForm = () => {
    ...
    // swaping te values of fromcurrency and tocurrency
    ...
    return (
        <form action="" className="converter-form" onSubmit={handleformsubmit}>
            ...
            <button className={`${isLoading ? "loading":""}submit-button`}>Get Exchange Rate</button>
            <p className="exchange-rate-result">{isLoading ? "Getting exchange value..": result}</p>
        </form>
    )
}
